"""
Ninja Userbot - Native Windows EXE Launcher
============================================
Downloads Python, installs dependencies, runs the GUI.
No web server, no localhost - pure native Windows app!
"""
...
def main() -> int:
    log("=" * 50)
    log("Ninja Launcher Starting (Native GUI Mode)")
    log("=" * 50)
